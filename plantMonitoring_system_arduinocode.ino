...
const int threshold = 35;  //threshold value to trigger pump

// Replace with your network details
const char* ssid = "Enter your SSID";
const char* password = "SSID password";

const char* serverName = "http://kplantmonitoring.info/post-data.php";
...
//Remember to enable less secure apps in your gmail account
    EMailSender emailSend("Enter the senders email ", "Enter the password of the sender's email");
...
void loop() {
  ...
  output_value = map(output_value,1400,3600,100,0);
  ...
  int httpResponseCode = http.POST(httpRequestData);
   ...
   if (httpResponseCode>0) {
    ...
    EMailSender::Response resp = emailSend.send("Enter the email that you want to send it to", message);
